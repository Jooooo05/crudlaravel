        ...
        {{-- update data --}}
                ...
                <div class="flex justify-center items-center">
                    <div class="bg-white w-[600px] p-8 rounded-md">
                        <div class=" mb-6">
                            <form action="{{ route('provinsi.update', ['id' => $data->id]) }}" method="POST">
                                @csrf
                                @method('put')
                                <div class="flex flex-col gap-4 bg-white bg-opacity-50 shadow-lg p-8">
                                    <div>
                                        ...
                                        <input value="{{ $data->kode }}" type="text" name="kode" id="kode" class="mt-1 p-2 block w-full shadow-sm focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md">
                                    </div>
                                    <div>
                                        <label for="nama_provinsi" class="block text-sm font-medium text-gray-700">Nama Provinsi:</label>
                                        <input value="{{ $data->nama_provinsi }}" type="text" name="nama_provinsi" id="nama_provinsi" class="mt-1 p-2 block w-full shadow-sm focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md">
                                    </div>
                                    <div class="">
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="{{ route('provinsi') }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded ml-2">Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
